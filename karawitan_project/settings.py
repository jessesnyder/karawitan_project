# Django settings for karawitan_project project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'karawitan_db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'm0)e+n=$t=ky+b=!ovln-81w-yqo#md0ii^qm-j&amp;z!#4t&amp;83lu'
...
ROOT_URLCONF = 'karawitan_project.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'karawitan_project.wsgi.application'
